...
Falling from a great height is a significant risk for adventurers and their foes. The rule given in the player's handbook is simple: at the end of a fall, you take `1d6` bludgeoning damage for every 10 feet you fell, to a maximum of `20d6`. You also land [prone](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Prone), unless you somehow avoid taking damage from the fall. Here are two optional rules that expand on that simple rule.

### Rate of Falling

The rule for falling assumes that a creature immediately drops the entire distance when it falls. But what if a creature is at a high altitude when it falls, perhaps on the back of a [griffon](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/monstrosity/griffon.md) or on board an [airship](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/items/airship.md)? Realistically, a fall from such a height can take more than a few seconds, extending past the end of the turn when the fall occurred. If you'd like high-altitude falls to be properly time-consuming, use the following optional rule.

When you fall from a great height, you instantly descend up to 500 feet. If you're still falling on your next turn, you descend up to 500 feet at the end of that turn. This process continues until the fall ends, either because you hit the ground or the fall is otherwise halted.

### Flying Creatures and Falling

A flying creature in flight falls if it is knocked [prone](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Prone), if its speed is reduced to 0 feet, or if it otherwise loses the ability to move, unless it can hover or it is being held aloft by magic, such as the [fly](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/spells/fly.md) spell.

If you'd like a flying creature to have a better chance of surviving a fall than a non-flying creature does, use this rule: subtract the creature's current flying speed from the distance it fell before calculating falling damage. This rule is helpful to a flier that is knocked [prone](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Prone) but is still conscious and has a current flying speed that is greater than 0 feet. The rule is designed to simulate the creature flapping its wings furiously or taking similar measures to slow the velocity of its fall.

If you use the rule for rate of falling in the previous section, a flying creature descends 500 feet on the turn when it falls, just as other creatures do. But if that creature starts any of its later turns still falling and is [prone](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Prone), it can halt the fall on its turn by spending half its flying speed to counter the [prone](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Prone) condition (as if it were standing up in midair).

## Sleep

Just as in the real world, D&D characters spend many hours sleeping, most often as part of a long rest. Most monsters also need to sleep. While a creature sleeps, it is subjected to the [unconscious](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Unconscious) condition. Here are a few rules that expand on that basic fact.
...
When you finish a long rest during which you slept in medium or heavy armor, you regain only one quarter of your spent Hit Dice (minimum of one die). If you have any levels of [exhaustion](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Exhaustion), the rest doesn't reduce your [exhaustion](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Exhaustion) level.
...
Whenever you end a 24-hour period without finishing a long rest, you must succeed on a DC 10 Constitution saving throw or suffer one level of [exhaustion](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Exhaustion).

It becomes harder to fight off [exhaustion](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Exhaustion) if you stay awake for multiple days. After the first 24 hours, the DC increases by 5 for each consecutive 24-hour period without a long rest. The DC resets to 10 when you finish a long rest.
...
The creature who ties the knot makes an Intelligence ([Sleight of Hand](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Sleight%20of%20Hand)) check when doing so. The total of the check becomes the DC for an attempt to untie the knot with an Intelligence ([Sleight of Hand](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Sleight%20of%20Hand)) check or to slip out of it with a Dexterity ([Acrobatics](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Acrobatics)) check.

This rule intentionally links [Sleight of Hand](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Sleight%20of%20Hand) with Intelligence, rather than Dexterity. This is an example of how to apply the rule in the ["Variant: Skills with Different Abilities"](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/variant-rules/skills-with-different-abilities-phb.md) section in chapter 7 of the player's handbook.
...
Tools have more specific applications than skills. The [History](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#History) skill applies to any event in the past. A tool such as a [forgery kit](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/items/forgery-kit.md) is used to make fake objects and little else. Thus, why would a character who has the opportunity to acquire one or the other want to gain a tool proficiency instead of proficiency in a skill?
...
In addition, consider giving characters who have both a relevant skill and a relevant tool proficiency an added benefit on a successful check. This benefit might be in the form of more detailed information or could simulate the effect of a different sort of successful check. For example, a character proficient with [mason's tools](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/items/masons-tools.md) makes a successful Wisdom ([Perception](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Perception)) check to find a secret door in a stone wall. Not only does the character notice the door's presence, but you decide that the tool proficiency entitles the character to an automatic success on an Intelligence ([Investigation](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Investigation)) check to determine how to open the door.
...
![](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/books/xanathars-guide-to-everything/img/c2001.webp#center)
...
See the [Identify a Spell](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/actions.md#Identify%20a%20Spell) entry.
...
![](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/variant-rules/img/xge-001.webp#center)
...
![](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/variant-rules/img/xge-002.webp#center)

![](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/variant-rules/img/xge-003.webp#center)
...
![Determine Numbers and Challenge Ratings; Solo Monster Challenge Rating](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/determine-numbers-and-challenge-ratings-solo-monster-challenge-rating-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 1st-5th Level](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/determine-numbers-and-challenge-ratings-multiple-monsters-1st-5th-level-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 6th-10th Level](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/determine-numbers-and-challenge-ratings-multiple-monsters-6th-10th-level-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 11th-15th Level](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/determine-numbers-and-challenge-ratings-multiple-monsters-11th-15th-level-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 16th-20th Level](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/determine-numbers-and-challenge-ratings-multiple-monsters-16th-20th-level-xge.md)
...
![](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/books/xanathars-guide-to-everything/img/c2005.webp#center)
...
![Monster Personality](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/monster-personality-xge.md)
...
![Monster Relationships](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/monster-relationships-xge.md)
...
![Quick Matchups](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/quick-matchups-xge.md)
...
![](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/books/xanathars-guide-to-everything/img/c2021.webp#center)

#### Running a Simple Trap

To prepare for using a simple trap in play, start by making note of the characters' passive Wisdom ([Perception](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Perception)) scores. Most traps allow Wisdom ([Perception](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Perception)) checks to detect their triggers or other elements that can tip off their presence. If you stop to ask players for this information, they might suspect a hidden danger.
...
- [Bear Trap](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/traps-hazards/bear-trap-xge.md)  
- [Crossbow Trap](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/traps-hazards/crossbow-trap-xge.md)  
- [Falling Portcullis](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/traps-hazards/falling-portcullis-xge.md)  
- [Fiery Blast Trap](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/traps-hazards/fiery-blast-trap-xge.md)  
- [Net Trap](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/traps-hazards/net-trap-xge.md)  
- [Pit Trap](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/traps-hazards/pit-trap-xge.md)  
- [Poison Needle Trap](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/traps-hazards/poison-needle-trap-xge.md)  
- [Scything Blade Trap](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/traps-hazards/scything-blade-trap-xge.md)  
- [Sleep of Ages Trap](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/traps-hazards/sleep-of-ages-trap-xge.md)  
...
![](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/books/xanathars-guide-to-everything/img/c2022.webp#center)
...
![Level and Lethality; Trap Save DCs and Attack Bonuses](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/level-and-lethality-trap-save-dcs-and-attack-bonuses-xge.md)

![Level and Lethality; Damage Severity by Level](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/level-and-lethality-damage-severity-by-level-xge.md)

![Level and Lethality; Spell Equivalent by Level](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/level-and-lethality-spell-equivalent-by-level-xge.md)
...
A trigger requires a Wisdom ([Perception](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Perception)) check if simply spotting it reveals its nature. The characters can foil a pit trap hidden by a leaf-covered net if they spot the pit through a gap in the leaves. A trip wire is foiled if it is spotted, as is a pressure plate.

Other traps require careful inspection and deduction to notice. A doorknob opens a door when turned to the left, but activates a trap when turned to the right. Such a subtle trap requires a successful Intelligence ([Investigation](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Investigation)) check to notice. The trigger is obvious. Understanding its nature is not.
...
Once you determine how a trap can be disarmed or avoided, decide the appropriate ability and skill combinations that characters can use. A Dexterity check using [thieves' tools](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/items/thieves-tools.md), a Strength ([Athletics](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Athletics)) check, and an Intelligence ([Arcana](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Arcana)) check are all commonly used for this purpose.

A Dexterity check using [thieves' tools](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/items/thieves-tools.md) can apply to any trap that has a mechanical element. [Thieves' tools](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/items/thieves-tools.md) can be used to disable a trip wire or a pressure plate, disassemble a poison needle mechanism, or clog a valve that leaks poisonous gas into a room.
...
A magic trap can be disabled by someone who can undermine the magic used to power it. Typically, a successful Intelligence ([Arcana](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Arcana)) check enables a character to figure out how a magic trap functions and how to negate its effect. For instance, the character could discover that a statue that belches a jet of magical flame can be disabled by shattering one of its glass eyes.
...
![](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/books/xanathars-guide-to-everything/img/c2024.webp#center)
...
![Experience for Complex Traps; Complex Trap Experience Awards](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/experience-for-complex-traps-complex-trap-experience-awards-xge.md)

### Example Complex Traps

The following complex traps can be used to challenge characters or to inspire your own creations.

- [Path of Blades](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/traps-hazards/path-of-blades-xge.md)  
- [Poisoned Tempest](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/traps-hazards/poisoned-tempest-xge.md)  
- [Sphere of Crushing Doom](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/traps-hazards/sphere-of-crushing-doom-xge.md)  
...
The trigger for a complex trap should be as foolproof as you can make it. A complex trap represents a serious expenditure of effort and magical power. No one builds such a trap and makes it easy to avoid. Wisdom ([Perception](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Perception)) and Intelligence ([Investigation](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Investigation)) checks might be unable to spot a trigger, especially a magical one, but they can still give hints about the trap before it triggers. Bloodstains, ashes, gouges in the floor, and other clues of that sort can serve as evidence of the trap's presence.
...
Not all of the characters' options need to be focused on stopping a trap from operating. Think of what characters can do to mitigate or avoid a trap's effects. Making the trap vulnerable to this sort of effort is a way to engage characters who might be ill-suited to confront the trap directly. A successful Intelligence ([Religion](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Religion)) check might provide insight into the imagery displayed by a trap in a temple or shrine, giving other characters a clue about how and where to direct their efforts. A character could stand in front of a dart trap while holding a shield that the darts can target harmlessly, while other characters trigger that element as they work to disable it.
...
![Creating a Rival; Rival](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/creating-a-rival-rival-xge.md)
...
![Buying a Magic Item; Buying Magic Items](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/buying-a-magic-item-buying-magic-items-xge.md)

![Buying a Magic Item; Magic Item Price](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/buying-a-magic-item-magic-item-price-xge.md)
...
![](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/books/xanathars-guide-to-everything/img/c2025.webp#center)
...
A character with the noble background can mingle with the upper class, but other characters can do so only if you judge that the character has made sufficient contacts. Alternatively, a character might use a [disguise kit](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/items/disguise-kit.md) and the [Deception](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Deception) skill to pass as a noble visiting from a distant city.

##### Resolution

After a workweek of carousing, a character stands to make contacts within the selected social class. The character makes a Charisma ([Persuasion](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Persuasion)) check using the Carousing table.

![Carousing](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/carousing-xge.md)
...
![Lower-Class Carousing Complications](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/lower-class-carousing-complications-xge.md)

![Middle-Class Carousing Complications](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/middle-class-carousing-complications-xge.md)

![Upper-Class Carousing Complications](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/upper-class-carousing-complications-xge.md)
...
![Crafting an Item; Resources and Resolution](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/crafting-an-item-resources-and-resolution-xge.md)
...
![](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/books/xanathars-guide-to-everything/img/c2026.webp#center)
...
![Crafting Magic Items; Magic Item Ingredients](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/crafting-magic-items-magic-item-ingredients-xge.md)
...
![Brewing Potions of Healing; Potion of Healing Creation](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/brewing-potions-of-healing-potion-of-healing-creation-xge.md)
...
At the end of the required time, the character chooses to make either an Intelligence ([Religion](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Religion)) check or a Charisma ([Persuasion](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Persuasion)) check. The total of the check determines the benefits of service, as shown on the Religious Service table.

![Religious Service](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/religious-service-xge.md)
...
![Religious Service Complications](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/religious-service-complications-xge.md)
...
![Research Outcomes](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/research-outcomes-xge.md)

![](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/books/xanathars-guide-to-everything/img/c2027.webp#center)
...
![Research Complications](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/research-complications-xge.md)
...
Scribing a spell scroll takes an amount of time and money related to the level of the spell the character wants to scribe, as shown in the Spell Scroll Costs table. In addition, the character must have proficiency in the [Arcana](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Arcana) skill and must provide any material components required for the casting of the spell. Moreover, the character must have the spell prepared, or it must be among the character's known spells, in order to scribe a scroll of that spell.

If the scribed spell is a cantrip, the version on the scroll works as if the caster were 1st level.

![Resources; Spell Scroll Costs](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/resources-spell-scroll-costs-xge.md)
...
![Scribe a Scroll Complications](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/scribe-a-scroll-complications-xge.md)
...
A character who wants to sell an item must make a Charisma ([Persuasion](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Persuasion)) check to determine what kind of offer comes in. The character can always opt not to sell, instead forfeiting the workweek of effort and trying again later. Use the Magic Item Base Prices and Magic Item Offer tables to determine the sale price.

![Selling a Magic Item; Magic Item Base Prices](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/selling-a-magic-item-magic-item-base-prices-xge.md)

![Selling a Magic Item; Magic Item Offer](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/selling-a-magic-item-magic-item-offer-xge.md)
...
![Magic Item Sale Complications](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/magic-item-sale-complications-xge.md)

![](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/books/xanathars-guide-to-everything/img/c2028.webp#center)
...
![Distribution by Rarity; Magic Items Awarded by Tier](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/distribution-by-rarity-magic-items-awarded-by-tier-xge.md)
...
![Magic Items Awarded by Rarity - Minor](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/magic-items-awarded-by-rarity-minor-xge.md)

![Magic Items Awarded by Rarity - Major](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/tables/magic-items-awarded-by-rarity-major-xge.md)
