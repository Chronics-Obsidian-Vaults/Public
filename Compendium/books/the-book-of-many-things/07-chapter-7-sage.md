...
The chapter concludes with two magic items. The [Deck of Many More Things](Compendium/items/deck-of-many-more-things-bmt.md) consists of cards created by spellcasters trying to add new cards to the [Deck of Many Things](Compendium/items/deck-of-many-things.md). The [Deck of Wonder](Compendium/items/deck-of-wonder-bmt.md) is a less powerful—and less dangerous—version of the more famous deck, appropriate for lower-level characters.

![](Compendium/books/the-book-of-many-things/img/035-06-001-sage.webp#center)
...
- [Feat: Cartomancer](Compendium/feats/cartomancer-bmt.md)  
...
![Spells](Compendium/tables/spells-bmt.md)

### Heroes of Destiny

The Sage Destinies table provides narrative ideas inspired by the [Deck of Many Things](Compendium/items/deck-of-many-things.md) that you can use while developing your character. The entries in this table are geared toward spellcasters, but they can enrich any character's story. When using this table, you can either choose the entries that speak to you or draw cards from the deck.

![Heroes of Destiny; Sage Destinies](Compendium/tables/heroes-of-destiny-sage-destinies-bmt.md)

## Magic Card Decks

This section presents two decks of magical cards.

- [Deck of Many More Things](Compendium/items/deck-of-many-more-things-bmt.md)  
- [Deck of Wonder](Compendium/items/deck-of-wonder-bmt.md)