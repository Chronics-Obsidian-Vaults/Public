...
Whether you're using [The Deck of Many Things](Compendium/items/deck-of-many-things.md) card set, oracle cards like tarokka cards or tarot cards, or a deck of playing cards, you can do things with cards that would be difficult or even impossible to do using dice:

![](Compendium/books/the-book-of-many-things/img/007-02-001-balance.webp#center)

- **Archetypes and Imagery.** When interpreting [The Deck of Many Things](Compendium/items/deck-of-many-things.md) card set and oracle cards, you can lean on the cards' imagery, not just numbers and words. A card's artwork can generate meaning for that card beyond whatever this book or any other text might tell you it means. Cards from Magic: The Gathering (https://gatherer.wizards.com/Pages/Card/Details.aspx?action=random) also work well for inspiration since they feature amazing fantasy art in addition to symbols. Ordinary playing cards' suits, one-eyed jacks, and other markings can be assigned additional meanings.  
...
> 
> The ""Card Sparks"" and ""Journey Spread"" sections ask you to interpret cards based on their assigned meaning. The reference book that accompanies [The Deck of Many Things](Compendium/items/deck-of-many-things.md) describes meanings for those cards, and the Curse of Strahd adventure summarizes the meanings of tarokka cards. Various books and websites explain the meanings of tarot cards.
^01c

![You can use Magic: The Gathering (https://gatherer.wizards.com/Pages/Card/Details.aspx?action=random) cards to build idea decks for creatures, items, people, or situations](Compendium/books/the-book-of-many-things/img/008-02-002-decks.webp#center)

The rest of this chapter is devoted to examples of how you can use these properties of cards to enrich your D&D game. If you're interested in further possibilities, the reference book that accompanies [The Deck of Many Things](Compendium/items/deck-of-many-things.md) card set also presents a method for using the deck to generate adventures, as well as advice on using them for in-game fortune-telling.
...
You can use [The Deck of Many Things](Compendium/items/deck-of-many-things.md) card set (or an equivalent deck built from twenty-two playing cards) to give players alternative ways to use inspiration.
...
![Inspiration Hand; Inspiration Cards](Compendium/tables/inspiration-hand-inspiration-cards-bmt.md)
...
The journey spread is a means of making long journeys more interesting. In this method, you place cards in a particular arrangement (a spread) and interpret them based on their meaning, position, and orientation. You can use [The Deck of Many Things](Compendium/items/deck-of-many-things.md) card set, tarokka cards, a tarot deck, or any other cards you can readily assign symbolic meanings to. This method works best for a journey you expect to last at least as many days as you have players.
...
- **Exhaustion.** The stress of overcoming the challenge exhausts the characters. Each character gains 2 levels of [exhaustion](Rules/conditions.md#Exhaustion).  
...
Here is an example of how you might interpret cards from [The Deck of Many Things](Compendium/items/deck-of-many-things.md) card set in a journey spread, with interpretations informed by the card descriptions in the reference book:

- **Day 1 Challenge.** Sage (Upright). The Sage card suggests an opportunity to gain insight or advice. Perhaps the characters come to a promontory that allows them to see the surrounding terrain for many miles. Ask the character who flipped the card to make a DC 15 Wisdom ([Perception](Rules/skills.md#Perception) or [Survival](Rules/skills.md#Survival)) check to choose the best path.  
...
- **Day 2 Reward or Ruin.** Fool. If the characters succeed on the majority of these saving throws, they stumble across a treasure: a [Hat of Disguise](Compendium/items/hat-of-disguise.md) or a similar item used to fool or deceive. The reversed Fool card implies disappointment or lost innocence; if they fail most of the saving throws, they gain 2 levels of [exhaustion](Rules/conditions.md#Exhaustion).  
...
- **Day 3 Reward or Ruin.** Gem. If the characters overcome the challenges of the menagerie, they discover valuable treasures there; if not, they must face one additional trap or monster that uses the appearance of treasure as bait, such as a [mimic](Compendium/bestiary/monstrosity/mimic.md).  
...
A friend is a creature that helps the characters fight the other creatures in an encounter. The friend might be the sole survivor of another adventuring party, a solitary traveler or recluse, or a benevolent monster like a [flumph](Compendium/bestiary/aberration/flumph.md) or an angel. The friend might have information about the adventure location or the creatures that dwell there.
...
Lurkers might include Humanoid foes like bandits, as well as ambush predators such as violet fungi, [ropers](Compendium/bestiary/monstrosity/roper.md), and [gargoyles](Compendium/bestiary/elemental/gargoyle.md).
...
The twins could be a pair of [displacer beasts](Compendium/bestiary/monstrosity/displacer-beast.md) or a [fire giant](Compendium/bestiary/giant/fire-giant.md) with two pet [hell hounds](Compendium/bestiary/fiend/hell-hound.md) (with the two hell hounds represented by a single card). Because you're more likely to draw both twin cards when the encounter deck has thinned out, the twin encounter should make for a climactic battle. Each twin should have a challenge rating about equal to the characters' level.

![A pair of displacer beasts in a dark forest has the makings of a memorable encounter](Compendium/books/the-book-of-many-things/img/012-02-005-displacer-beasts.webp#center)
...
![Forest Encounter Deck](Compendium/tables/forest-encounter-deck-bmt.md)

![Corrupted Lands Encounter Deck](Compendium/tables/corrupted-lands-encounter-deck-bmt.md)