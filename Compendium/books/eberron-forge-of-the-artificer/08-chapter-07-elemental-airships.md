...
![Conflict between houses escalates to the skies as elemental airships join in battle](Compendium/books/eberron-forge-of-the-artificer/img/066-07-001-airship-battle.webp#center)
...
The pilot (the crew member operating an airship's Helm) must have the [Mark of Storm](Compendium/feats/mark-of-storm-efa.md) to interface with the controls. While operating the Helm, a crew member can take the station's Drive and Shift Engine actions.
...
![Crashing; Crash Damage](Compendium/tables/crashing-crash-damage-efa.md)
...
> [!note] Piloting without a Dragonmark
> 
...
![](Compendium/books/eberron-forge-of-the-artificer/img/067-07-002-airship-getaway.webp#center)
...
- [Lyrandar Air Cruiser](Compendium/vehicles/lyrandar-air-cruiser-efa.md)  
- [Lyrandar Skyskiff](Compendium/vehicles/lyrandar-skyskiff-efa.md)  
- [Strider Airship](Compendium/vehicles/strider-airship-efa.md)  
...
If a creature with the [Mark of Passage](Compendium/feats/mark-of-passage-efa.md) takes the Boost action, the ship's Fly Speed increases by 100 feet instead.
...
The ship regains `2d8` Hit Points.

This station facilitates quick repairs aboard an airship. It can accommodate up to three Medium creatures.

A creature inside the Repair Clamps station has Half Cover. A crew member operating an airship's Repair Clamps requires the [Mark of Making](Compendium/feats/mark-of-making-efa.md) to interface with the controls. While operating the Repair Clamps, a crew member can take the Quick Repair action.
...
If a creature with the [Mark of Shadow](Compendium/feats/mark-of-shadow-efa.md) occupies this crew station, that creature can take the Cloak action as a Bonus Action.
...
![Encounter Distance; Airship Travel Conditions](Compendium/tables/encounter-distance-airship-travel-conditions-efa.md)
...
> [!embed-table]- Airborne Encounters
> ![Airborne Encounters](Compendium/tables/airborne-encounters-efa.md)
...
On a failed check, the ship goes off course. The DM decides what the final consequences of this are, but at base, the airship's journey is extended by `1d4` days.
...
![Weather Hazards; Environmental Hazards](Compendium/tables/weather-hazards-environmental-hazards-efa.md)
