...
![](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/items/img/duskcrusher.webp#right)
...
While you are holding Duskcrusher and its radiant head is active, you can use an action to cast the [sunbeam](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/spells/sunbeam.md) spell (save DC 15) from the weapon, and this action can't be used again until the next dawn.
