...
![](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/items/img/infiltrators-key.webp#right)
...
- The key can be used as [thieves' tools](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/items/thieves-tools.md) for the purpose of opening locks. When using the key, you are considered proficient in [thieves' tools](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/items/thieves-tools.md) and you have advantage on ability checks made to open locks.  
- While holding the key, your steps are muffled, giving you advantage on Dexterity ([Stealth](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Stealth)) checks made to move silently.  
...
- While holding the key, you can use an action to cast one of the following spells from it: [alter self](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/spells/alter-self.md), [invisibility](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/spells/invisibility.md), [knock](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/spells/knock.md), or [pass without trace](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/spells/pass-without-trace.md). Once a spell has been cast using the key, it can't be used to cast that spell again until the next dawn.  
...
- While holding the key, you can use an action to cast one of the following spells from it: [dimension door](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/spells/dimension-door.md), [gaseous form](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/spells/gaseous-form.md), or [mislead](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/spells/mislead.md). Once a spell has been cast using the key, it can't be used to cast that spell again until the next dawn.  
