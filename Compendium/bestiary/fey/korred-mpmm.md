...
- Korred
---
# [Korred](Campaigns\Chronics of the Times Before\Public\Compendium\bestiary\fey/korred-mpmm.md)
...
Korreds prefer to keep their own company but occasionally consort with creatures of elemental earth such as [galeb duhr](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/elemental/galeb-duhr.md). They often gather with other korreds to perform ceremonial dances, beating out rhythms on stone with their hooves and clubs. In the depths of the Material Plane, korreds typically flee from other creatures, but they become aggressive when they feel insulted or are annoyed by the sounds of mining.
...
"cr": "7"
"traits":
  - "desc": "The korred has advantage on Dexterity ([Stealth](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Stealth))\
...
"actions":
  ...
  - "desc": "The korred casts one of the following spells, requiring no spell components\
      ...
      \ (as an action), [meld into stone](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/spells/meld-into-stone.md),\
      \ [stone shape](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/spells/stone-shape.md)\n\
      \n**1/day:** [Otto's irresistible dance](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/spells/ottos-irresistible-dance.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The korred has at least one 50-foot-long rope woven out of its hair.\
      ...
      \ must succeed on a DC 13 Dexterity saving throw or become [grappled](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Grappled)\
      \ by the rope (escape DC 13). Until this grapple ends, the target is [restrained](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Restrained).\
      \ The korred can use a bonus action to release the target, which is also freed\
      \ if the korred dies or becomes [incapacitated](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Incapacitated).\n\
...
"source":
  - "MPMM"
  - "VGM"
"image": "/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/fey/token/korred-mpmm.webp"
```
^statblock
