...
- Frost Salamander
---
# [Frost Salamander](Campaigns\Chronics of the Times Before\Public\Compendium\bestiary\elemental/frost-salamander-mpmm.md)
...
Frost salamanders' aggressive appetite for any heat source leads them to attack expeditions and settlements that other predators would avoid, as they often mistake the fire of a forge or a campfire for a large, tasty meal. [Azers](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/elemental/azer.md) use this predilection to hunt frost salamanders. Venturing into the Frostfell, they use large fires to lure these creatures into traps, then kill them and collect their hides and fangs for use in crafting weapons and armor.
...
On rare occasions, [frost giants](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/giant/frost-giant.md) capture and tame these creatures, using them to burrow into the ice to help create outposts and fortresses.
...
"source":
  - "MPMM"
  - "MTF"
"image": "/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/elemental/token/frost-salamander-mpmm.webp"
```
^statblock
