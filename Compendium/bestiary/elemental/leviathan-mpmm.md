...
"actions":
  ...
  - "desc": "The leviathan magically creates a wave of water that extends from a point\
      ...
      \ bludgeoning damage and is knocked [prone](Rules/conditions.md#Prone). On a\
      \ successful save, a creature takes half as much damage and isn't knocked [prone](Rules/conditions.md#Prone).\
