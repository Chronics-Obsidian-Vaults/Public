...
- Woe Strider
---
# [Woe Strider](Campaigns\Chronics of the Times Before\Public\Compendium\bestiary\aberration/woe-strider-mot.md)
...
"actions":
  - "desc": "The woe strider makes two claw attacks and one bite attack. If both claws\
      \ hit the same creature, the target is [grappled](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Grappled)\
      \ (escape DC 14)."
    "name": "Multiattack"
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 10 ft., one target. *Hit:* 7\
      \ (1d6 + 4) slashing damage plus 3 (1d6) psychic damage."
    "name": "Claw"
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 5 ft., one creature that is [grappled](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Grappled),\
...
"source":
  - "MOT"
"image": "/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/aberration/token/woe-strider-mot.webp"
```
^statblock