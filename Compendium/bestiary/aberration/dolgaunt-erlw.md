...
- Dolgaunt
---
# [Dolgaunt](Campaigns\Chronics of the Times Before\Public\Compendium\bestiary\aberration/dolgaunt-erlw.md)
...
"traits":
  - "desc": "If the dolgaunt is subjected to an effect that allows it to make a Dexterity\
      ...
      \ use this trait if it's [incapacitated](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Incapacitated)."
    "name": "Evasion"
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 15 ft., one target. *Hit:* 7\
      \ (1d6 + 4) bludgeoning damage. The target is [grappled](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Grappled)\
...
"source":
  - "ERLW"
"image": "/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/aberration/token/dolgaunt-erlw.webp"
```
^statblock