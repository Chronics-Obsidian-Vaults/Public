...
"bonus_actions":
  - "desc": "The berbalang creates one spectral duplicate of itself in an unoccupied\
      ...
      \ one duplicate at a time. The duplicate disappears when it or the berbalang\
      \ drops to 0 hit points or when the berbalang dismisses it (no action required).\n\
      \nThe duplicate has the same statistics and knowledge as the berbalang, and\
      \ everything experienced by the duplicate is known by the berbalang. All damage\
