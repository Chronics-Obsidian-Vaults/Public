...
- source/monster/type/fiend/shapechanger
statblock: inline
statblock-link: "#^statblock"
aliases:
- Incubus
---
# [Incubus](Campaigns\Chronics of the Times Before\Public\Compendium\bestiary\fiend/incubus.md)
*Source: Monster Manual p. 285, Eberron: Rising from the Last War, Explorer's Guide to Wildemount, Tasha's Cauldron of Everything. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
"source":
  ...
  - "EGW"
  - "TCE"
"image": "/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/fiend/token/incubus.webp"
```
^statblock
