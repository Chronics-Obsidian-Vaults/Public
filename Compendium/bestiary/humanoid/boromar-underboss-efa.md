...
- "Boromar Underboss"
---
# [Boromar Underboss](Compendium/bestiary/humanoid/boromar-underboss-efa.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 13 (2d8 + 4) Slashing damage\
      \ plus 7 (2d6) Poison damage, and the target has the Poisoned condition until\
      \ the start of the underboss's next turn. If the target is already Poisoned,\
...
"source":
  - "EFA"
"image": "Compendium/bestiary/humanoid/token/boromar-underboss-efa.webp"
```
^statblock