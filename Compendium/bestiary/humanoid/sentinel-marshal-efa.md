...
- "Sentinel Marshal"
---
# [Sentinel Marshal](Compendium/bestiary/humanoid/sentinel-marshal-efa.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 13 (2d8 + 4) Slashing damage,\
      \ and the target has <span title=\"Player's Handbook (2024)\">Disadvantage</span>\
...
"source":
  - "EFA"
"image": "Compendium/bestiary/humanoid/token/sentinel-marshal-efa.webp"
```
^statblock