...
- "Shadow-Marked Agent"
---
# [Shadow-Marked Agent](Compendium/bestiary/humanoid/shadow-marked-agent-efa.md)
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +8, reach 5 ft. or range 20/60 ft. *Hit:*\
      ...
      \ <span title=\"Player's Handbook (2024)\">Speed</span> is reduced by 10 feet\
...
"source":
  - "EFA"
"image": "Compendium/bestiary/humanoid/token/shadow-marked-agent-efa.webp"
```
^statblock