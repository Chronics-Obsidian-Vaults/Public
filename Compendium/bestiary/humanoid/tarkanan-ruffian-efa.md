...
- "Tarkanan Ruffian"
---
# [Tarkanan Ruffian](Compendium/bestiary/humanoid/tarkanan-ruffian-efa.md)
...
"cr": "1"
"traits":
  - "desc": "When the ruffian casts Witch Bolt, roll 1d8. On an even number, the ruffian\
      \ gains a number of <span title=\"Player's Handbook (2024)\">Temporary Hit Points</span>\
...
"source":
  - "EFA"
"image": "Compendium/bestiary/humanoid/token/tarkanan-ruffian-efa.webp"
```
^statblock