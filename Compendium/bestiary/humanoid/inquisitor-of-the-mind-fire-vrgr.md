...
"actions":
  ...
  - "desc": "The inquisitor targets one creature it can see within 120 feet of it.\
      ...
      \ + 4) psychic damage and be [stunned](Rules/conditions.md#Stunned) until the\
      \ start of the inquisitor's next turn."
    "name": "Mind Fire"
  - "desc": "Each creature of the inquisitor's choice that it can see within 60 feet\
      ...
      \ Attack (inquisitor chooses the target) or [Dash](Rules/actions.md#Dash) action."
