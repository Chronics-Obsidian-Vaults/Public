...
- source/monster/type/humanoid/leonin
statblock: inline
statblock-link: "#^statblock"
aliases:
- Leonin Iconoclast
---
# [Leonin Iconoclast](Campaigns\Chronics of the Times Before\Public\Compendium\bestiary\humanoid/leonin-iconoclast-mot.md)
...
"traits":
  ...
  - "desc": "If the leonin is subjected to an effect that allows it to make a Dexterity\
      ...
      \ if it's [incapacitated](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Incapacitated)."
    "name": "Evasion"
...
"source":
  - "MOT"
"image": "/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/humanoid/token/leonin-iconoclast-mot.webp"
```
^statblock