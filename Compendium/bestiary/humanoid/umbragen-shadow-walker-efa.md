...
---
# [Umbragen Shadow Walker](Compendium/bestiary/humanoid/umbragen-shadow-walker-efa.md)
...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 17, one creature the shadow walker can see\
      ...
      \ Blinded condition until the start of the shadow walker's next turn."
    "name": "Shadow Cowl"
...
"source":
  - "EFA"
"image": "Compendium/bestiary/humanoid/token/umbragen-shadow-walker-efa.webp"
```
^statblock