...
- "Tarkanan Marauder"
---
# [Tarkanan Marauder](Compendium/bestiary/humanoid/tarkanan-marauder-efa.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 13 (3d6 + 3) Piercing damage,\
      \ plus 21 (6d6) Force damage if the marauder had <span title=\"Player's Handbook\
      \ (2024)\">Advantage</span> on the attack roll."
...
"source":
  - "EFA"
"image": "Compendium/bestiary/humanoid/token/tarkanan-marauder-efa.webp"
```
^statblock