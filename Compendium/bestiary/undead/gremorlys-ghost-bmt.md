...
- Gremorly's Ghost
---
# [Gremorly's Ghost](Campaigns\Chronics of the Times Before\Public\Compendium\bestiary\undead/gremorlys-ghost-bmt.md)
...
"actions":
  ...
  - "desc": "One Humanoid Gremorly can see within 5 feet of himself must succeed on\
      ...
      \ and the target has the [incapacitated](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Incapacitated)\
      \ condition and loses control of its body. Gremorly can't be targeted by any\
      \ attack, spell, or other effect, except ones that turn Undead, and he retains\
      \ his alignment, Intelligence, Wisdom, Charisma, and immunity to the [charmed](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Charmed)\
      \ and [frightened](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Frightened)\
      \ conditions. He otherwise uses the target's game statistics, but Gremorly doesn't\
      \ gain access to the target's knowledge, class features, or proficiencies.\n\
      \nThe possession lasts until the target drops to 0 hit points, Gremorly ends\
      \ it as a bonus action, or Gremorly is turned or forced out by an effect like\
      \ the [Dispel Evil and Good](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/spells/dispel-evil-and-good.md)\
      \ spell. When the possession ends, Gremorly reappears in an unoccupied space\
      \ within 5 feet of the target. The target is immune to this Possession for 24\
  ...
  - "desc": "Gremorly casts one of the following spells, using Intelligence as the\
      ...
      \n**1/day:** [Slow](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/spells/slow.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "BMT"
"image": "/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/undead/token/gremorlys-ghost-bmt.webp"
```
^statblock