...
"senses": "[blindsight](Rules/senses.md#Blindsight) 120 ft. (blind beyond this radius);\
  \ see also \"detect sentience\" below, passive Perception 10"
...
"traits":
  - "desc": "The brain's innate spellcasting ability is Intelligence (spell save DC\
      ...
      \ [sleep](Compendium/spells/sleep.md) (3rd-level version), [Tasha's hideous\
...
"actions":
  ...
  - "desc": "The brain magically emits psychic energy in a 60-foot cone. Each creature\
      ...
      \ (3d8 + 4) psychic damage and be [stunned](Rules/conditions.md#Stunned) for\
      \ 1 minute. A [stunned](Rules/conditions.md#Stunned) creature can repeat the\
