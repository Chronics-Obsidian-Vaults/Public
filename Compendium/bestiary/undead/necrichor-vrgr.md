...
"traits":
  ...
  - "desc": "Unless its lifeless remains are splashed with [holy water](Compendium/items/holy-water-flask.md)\
      \ or placed in a vessel under the effects of the [hallow](Compendium/spells/hallow.md)\
...
"actions":
  ...
  - "desc": "The necrichor targets a creature it can see within 5 feet of it that\
      ...
      \ the Attack action (necrichor chooses the target) or the [Dash](Rules/actions.md#Dash)\
