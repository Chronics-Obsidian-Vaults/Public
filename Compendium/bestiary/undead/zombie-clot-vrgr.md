...
"actions":
  ...
  - "desc": "The zombie flings a detached clump of corpses at a creature it can see\
      ...
      \ dead flesh is [restrained](Rules/conditions.md#Restrained), has total cover\
      \ against attacks and other effects outside the dead flesh, and takes 10 (3d6)\
      \ necrotic damage at the start of each of its turns. The creature can be freed\
      \ if the dead flesh is destroyed. The dead flesh is a Large object with AC 10,\
      \ 25 hit points, and immunity to poison and psychic damage."
