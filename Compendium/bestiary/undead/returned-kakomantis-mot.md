...
- Returned Kakomantis
---
# [Returned Kakomantis](Campaigns\Chronics of the Times Before\Public\Compendium\bestiary\undead/returned-kakomantis-mot.md)
...
"traits":
  ...
  - "desc": "The Returned is immune to any effect that would sense its emotions or\
      \ read its thoughts. Wisdom ([Insight](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Insight))\
...
"source":
  - "MOT"
"image": "/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/undead/token/returned-kakomantis-mot.webp"
```
^statblock