...
---
# [Vos'skyriss Serpentfolk Ghost](Campaigns\Chronics of the Times Before\Public\Compendium\bestiary\undead/vosskyriss-serpentfolk-ghost-tdcsr.md)
...
Most serpentfolk have little love for the [Cloaked Serpent](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/deities/exandria-the-cloaked-serpent-tdcsr.md), though they pay him homage as the deity of poisons, assassins, and darkness. For the Vos'skyriss serpentfolk, worship is a means to an end. Their legends say that the devout will be granted the ability to devour nightmares, enabling them to gorge themselves on dreams of fear and terror until they grow so large that they can turn on their god and swallow the [Cloaked Serpent](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/deities/exandria-the-cloaked-serpent-tdcsr.md) himself. Once begun, this feast is unending—they will devour the remaining gods one by one, and finally, the entirety of the multiverse.
...
"actions":
  ...
  - "desc": "The ghost emits an uncanny, rasping hiss. Each non-undead creature within\
      ...
      \ throw or be [frightened](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Frightened)\
      ...
      \ the condition on itself on a success. If a target's saving throw is successful\
      \ or the effect ends for it, the target is immune to this ghost's Terrifying\
      \ Hiss for the next 24 hours."
    "name": "Terrifying Hiss"
"source":
  - "TDCSR"
"image": "/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/undead/token/vosskyriss-serpentfolk-ghost-tdcsr.webp"
```
^statblock
