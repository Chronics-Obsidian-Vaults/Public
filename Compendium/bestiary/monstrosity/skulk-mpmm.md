...
"traits":
  - "desc": "The skulk is [invisible](Rules/conditions.md#Invisible). This invisibility\
      ...
      \ a corpse whose identity is unknown.  \n- **Children.** Humanoid children,\
      \ aged 10 and under, can see through this invisibility.  \n- **Reflective Surfaces.**\
      \ The skulk appears as a drab, smooth-skinned biped if its reflection can be\
      \ seen in a mirror or on another surface.  "
