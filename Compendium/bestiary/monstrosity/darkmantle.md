...
- Darkmantle
---
# [Darkmantle](Campaigns\Chronics of the Times Before\Public\Compendium\bestiary\monstrosity/darkmantle.md)
...
"cr": "1/2"
"traits":
  - "desc": "The darkmantle can't use its blindsight while [deafened](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Deafened)."
    "name": "Echolocation"
...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one creature. *Hit:* 6\
      ...
      \ roll, it attaches by engulfing the target's head, and the target is also [blinded](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Blinded)\
  ...
  - "desc": "A 15-foot radius of magical darkness extends out from the darkmantle,\
      ...
      \ darkmantle maintains [concentration](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Concentration),\
      \ up to 10 minutes (as if [concentrating](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Concentration)\
...
"source":
  - "MM"
"image": "/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/monstrosity/token/darkmantle.webp"
```
^statblock
