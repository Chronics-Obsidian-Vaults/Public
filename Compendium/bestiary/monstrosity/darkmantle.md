...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one creature. *Hit:* 6\
      ...
      \ roll, it attaches by engulfing the target's head, and the target is also [blinded](Rules/conditions.md#Blinded)\
  ...
  - "desc": "A 15-foot radius of magical darkness extends out from the darkmantle,\
      ...
      \ darkmantle maintains [concentration](Rules/conditions.md#Concentration), up\
      \ to 10 minutes (as if [concentrating](Rules/conditions.md#Concentration) on\
