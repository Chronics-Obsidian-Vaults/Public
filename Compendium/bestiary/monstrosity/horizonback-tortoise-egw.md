...
"traits":
  ...
  - "desc": "The tortoise can carry up to 20,000 pounds of weight atop its shell,\
      ...
      \ creatures can move underneath the tortoise while it's not [prone](Rules/conditions.md#Prone).\n\
      \nAny creature under the tortoise when it falls [prone](Rules/conditions.md#Prone)\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +12 to hit, reach 10 ft., one target. *Hit:* 28\
    ...
    "name": "Bite"
  - "desc": "The tortoise withdraws into its shell, falls [prone](Rules/conditions.md#Prone),\
...
"source":
  - "EGW"
"image": "Compendium/bestiary/monstrosity/token/horizonback-tortoise-egw.webp"
```
^statblock