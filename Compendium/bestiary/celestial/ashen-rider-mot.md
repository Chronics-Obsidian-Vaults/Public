...
- Ashen Rider
---
# [Ashen Rider](Campaigns\Chronics of the Times Before\Public\Compendium\bestiary\celestial/ashen-rider-mot.md)
...
"traits":
  ...
  - "desc": "When a creature starts its turn within 30 feet of the ashen rider, the\
      ...
      \ the next 24 hours. On a failed save, the creature can't speak and is [deafened](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Deafened)\
  ...
  - "desc": "If the ashen rider isn't mounted, it can use a bonus action to magically\
      ...
      \ the ashen rider can't be [surprised](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Surprised),\
...
"source":
  - "MOT"
"image": "/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/celestial/token/ashen-rider-mot.webp"
```
^statblock