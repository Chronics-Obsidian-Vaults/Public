...
"traits":
  - "desc": "If the carrionette is motionless at the start of combat, it has advantage\
      ...
      \ move or act, that creature must succeed on a DC 15 Wisdom ([Perception](Rules/skills.md#Perception))\
...
"actions":
  ...
  - "desc": "The carrionette targets a creature it can see within 15 feet of it that\
      ...
      \ body, and the target is [unconscious](Rules/conditions.md#Unconscious) for\
      ...
      \ the carrionette's body is destroyed, both the carrionette and the target die.\
      \ A [protection from evil and good](Compendium/spells/protection-from-evil-and-good.md)\
