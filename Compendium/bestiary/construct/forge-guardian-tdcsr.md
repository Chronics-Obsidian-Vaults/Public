...
- Forge Guardian
---
# [Forge Guardian](Campaigns\Chronics of the Times Before\Public\Compendium\bestiary\construct/forge-guardian-tdcsr.md)
...
Just as "dwarves" created the earliest golems, the [All-Hammer](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/deities/exandria-the-all-hammer-tdcsr.md) fashioned forge guardians to guard the divine furnaces and hearths that designed the first "dwarves". Shaped from extravagant marble and fused with adamantine, crafted with impeccable detail and care, these rare and massive constructs exemplify the highest form of artistry that every Exandrian blacksmith, forgemaster, and artisan spends a life-time hoping to achieve.

### Divine Spark

A faceless, tireless being of immense strength, a forge golem is gifted life by a single shard from the [All-Hammer's](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/deities/exandria-the-all-hammer-tdcsr.md) own divine spark, lovingly kept safe inside a ring of arcane flame and ancient sigils. The [All-Hammer's](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/deities/exandria-the-all-hammer-tdcsr.md) divinity is akin to a volcano inside the golem, turning the construct's blood into lava. Fire no longer harms the construct, but instead heals it.
...
Forge golems also serve as opponents for any wishing to engage in the [All-Hammer's](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/deities/exandria-the-all-hammer-tdcsr.md) trial of worthiness. A golem's attacks blind prospective heroes, who must then earn back their vision by risking a deadly counterattack.
...
"cr": "27"
"traits":
  - "desc": "Whenever the guardian is subjected to fire damage, it takes no damage\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +18 to hit, reach 15 ft., one target. *Hit:* 36\
      ...
      \ until it deals damage to the guardian."
    "name": "Runeblade"
  - "desc": "*Melee Weapon Attack:* +18 to hit, reach 10 ft., one target. *Hit:* 23\
      ...
      \ from the guardian and knocked [prone](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Prone)."
    "name": "Kick"
  - "desc": "The guardian makes a Runeblade attack against every creature within 15\
      \ feet of it. On a hit, a target is also pushed up to 15 feet away from the\
      \ guardian and knocked [prone](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Prone)."
    "name": "Bladestorm (Recharge 5-6)"
"legendary_description": "Legendary Action Uses: 3. Immediately after another creature's\
  \ turn, the forge guardian can expend a use to take one of the following actions.\
  \ The forge guardian regains all expended uses at the start of each of its turns."
"legendary_actions":
  - "desc": "The guardian makes one Runeblade attack."
    "name": "Runeblade"
  - "desc": "The guardian makes one Kick attack."
    "name": "Kick"
  - "desc": "The guardian moves up to 50 feet without triggering [opportunity attacks](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/actions.md#Opportunity%20Attack),\
      ...
      \ the creature takes 23 (2d12 + 10) bludgeoning damage and is knocked [prone](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Prone).\
      \ On a success, the creature takes half as much damage and isn't knocked [prone](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Prone).\
      \ Any creature that shares the guardian's space when it stops this movement\
      \ is pushed out of its space into the nearest unoccupied space."
    "name": "Trample (Costs 2 Actions)"
"source":
  - "TDCSR"
"image": "/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/construct/token/forge-guardian-tdcsr.webp"
```
^statblock