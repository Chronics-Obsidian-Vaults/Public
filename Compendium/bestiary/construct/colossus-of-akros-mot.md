...
- Colossus of Akros
---
# [Colossus of Akros](Campaigns\Chronics of the Times Before\Public\Compendium\bestiary\construct/colossus-of-akros-mot.md)
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Weapon Attack:* +16 to hit, reach 15 ft., or range\
      ...
      \ 9) piercing damage if used with two hands to make a melee attack. If the colossus\
      \ makes a ranged attack with this spear, the spear magically returns to its\
...
"source":
  - "MOT"
"image": "/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/construct/token/colossus-of-akros-mot.webp"
```
^statblock