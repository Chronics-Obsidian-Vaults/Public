...
- Stone Cursed
---
# [Stone Cursed](Campaigns\Chronics of the Times Before\Public\Compendium\bestiary\construct/stone-cursed-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 233, Mordenkainen's Tome of Foes p. 240*  

Stone cursed are spawned through a foul alchemical ritual performed on a Humanoid that has been turned to stone. The ritual, which requires a mixture of basilisk blood and the ashes from the burned feathers of a cockatrice, awakens a dim echo of the [petrified](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Petrified) victim's spirit, animating the statue and turning it into a useful guardian.
...
Even though a creature transformed into a stone cursed is long dead, a vague whisper of their memories lives on in the obsidian skull embedded within the stone cursed's body. At the end of a short rest, a character can make a DC 20 Intelligence ([Arcana](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Arcana)) check to attempt to extract a memory from the skull that is a response to a verbal question posed to the skull by the character. Once this check is made, whether it succeeds or fails, the skull can't be used in this manner again.
...
"cr": "1"
"traits":
  - "desc": "The stone cursed has advantage on the attack rolls of [opportunity attacks](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/actions.md#Opportunity%20Attack)."
  ...
  - "desc": "If the stone cursed is motionless at the start of combat, it has advantage\
      ...
      \ cursed move or act, that creature must succeed on a DC 18 Intelligence ([Investigation](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/skills.md#Investigation))\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 12\
      ...
      \ a DC 12 Constitution saving throw, or it begins to turn to stone and is [restrained](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Restrained)\
      \ until the end of its next turn, when it must repeat the saving throw. The\
      \ effect ends if the second save is successful; otherwise the target is [petrified](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Petrified)\
      \ for 24 hours."
    "name": "Petrifying Claws"
"source":
  - "MPMM"
  - "MTF"
"image": "/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/construct/token/stone-cursed-mpmm.webp"
```
^statblock
