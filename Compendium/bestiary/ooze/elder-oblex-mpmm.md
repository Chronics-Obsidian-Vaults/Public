...
- source/monster/type/ooze
statblock: inline
statblock-link: "#^statblock"
aliases:
- Elder Oblex
---
# [Elder Oblex](Campaigns\Chronics of the Times Before\Public\Compendium\bestiary\ooze/elder-oblex-mpmm.md)
...
"actions":
  ...
  - "desc": "The oblex targets one creature it can see within 5 feet of it. The target\
      ...
      \ d6, the d6 becomes a d8, and so on until the die becomes a d20, at which point\
      \ the target becomes [unconscious](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Rules/conditions.md#Unconscious)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/bestiary/ooze/token/elder-oblex-mpmm.webp"
```
^statblock
