...
You have <span title="Player's Handbook (2024)">Resistance</span> to Poison damage. You also have <span title="Player's Handbook (2024)">Advantage</span> on saving throws to avoid or end the Poisoned condition.

### Integrated Protection

You gain a +1 bonus to your <span title="Player's Handbook (2024)">Armor Class</span>. In addition, armor you have donned can't be removed against your will while you're alive.

### Sentry's Rest

You don't need to sleep, and magic can't put you to sleep. You can finish a <span title="Player's Handbook (2024)">Long Rest</span> in 6 hours if you spend those hours in an inactive, motionless state. During this time, you appear inert but remain conscious.
