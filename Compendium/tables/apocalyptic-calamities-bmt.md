...
| dice: d12 | Calamity |
|-----------|----------|
| 1 | The [tarrasque](Compendium/bestiary/monstrosity/tarrasque.md) awakens. (A [kraken](Compendium/bestiary/monstrosity/kraken.md), an [empyrean](Compendium/bestiary/celestial/empyrean.md), or another titan might also serve as an agent of apocalyptic wrath.) |
...
| 10 | Magic goes awry, creating random zones of wild magic (where casting any spell of 1st level or higher causes a roll on the [Wild Magic Surge table](Compendium/tables/wild-magic-surge-phb.md) in the "Player's Handbook") and dead magic (like an [Antimagic Field](Compendium/spells/antimagic-field.md) spell on a larger scale). |
