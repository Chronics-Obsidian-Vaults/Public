...
aliases:
- "Alternative Resurrection Rule: The Fading Spirit"
---
# Alternative Resurrection Rule: The Fading Spirit
*Source: Tal'Dorei Campaign Setting p. 119* 
...
For example, praying to the god of the devout, fallen character may require an Intelligence ([Religion](Rules/skills.md#Religion)) check at an easy to medium difficulty, where loudly demanding the soul of the fallen to return from the aether may require a Charisma ([Intimidation](Rules/skills.md#Intimidation)) check at a very hard or nearly impossible difficulty. Advantage and disadvantage can apply here based on how perfect, or off base, the contribution offered is.
...
Only the strongest of magical incantations can bypass this resurrection challenge, in the form of the [true resurrection](Compendium/spells/true-resurrection.md) or [wish](Compendium/spells/wish.md) spells. These spells can also restore a character to life who was lost due to a failed resurrection ritual, should you allow it.

## Quick Resurrections

If a spell with a casting time of 1 action is used to attempt to restore life (via the [Revivify](Compendium/spells/revivify.md) spell or similar effects), no contribution skill checks are allowed. The character casting the spell makes a Rapid Resurrection check, rolling a d20 and adding their spellcasting ability modifier. The DC is 10, increasing by 1 for each previous successful resurrection the character has undergone. On a failure, the character's soul is not lost, but the resurrection fails and increases any future Resurrection checks' DC by 1. No further attempts can be made to restore this character to life until a resurrection spell with a casting time higher than 1 action is attempted.