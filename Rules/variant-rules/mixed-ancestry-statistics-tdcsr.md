...
Only certain combinations of ancestries, such as [half-elves](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/races/half-elf.md) and [half-orcs](/Campaigns/Chronics%20of%20the%20Times%20Before/Public/Compendium/races/half-orc.md), already have racial traits described in the fifth edition core rules. You can use these racial traits as is, or create your own "mixed ancestry" from any two races by choosing one or two racial traits from one parent's race and exchanging them for the same number of traits from another parent's race.
